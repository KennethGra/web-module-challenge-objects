...
*/
console.log('task 1b', createMenuItem('milk', 3, 'Drinks'));
console.log('task 1b', createMenuItem('fried chicken', 12, 'Lunch'));
console.log('task 1b', createMenuItem('tea', 2, 'Drinks'));
